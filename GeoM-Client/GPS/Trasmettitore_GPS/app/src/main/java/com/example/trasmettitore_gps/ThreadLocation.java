...
public class ThreadLocation extends Thread {
    ...
    public void run() {
        if (ActivityCompat.checkSelfPermission(a.getApplicationContext(), Manifest.permission.ACCESS_FINE_LOCATION) !=
                PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(a.getApplicationContext(), Manifest.permission.ACCESS_COARSE_LOCATION) !=
